...
global.owner = process.env.OWNER_NUMBER  || '7548054204' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=bNVWXBDA#W5CjcTWOUn60_S_5LE2ycugxtVfNu1g5_th2Zo11leU' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "7548054204" : process.env.MODERATORS ,    
